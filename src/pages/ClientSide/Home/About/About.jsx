...
const About = () => {
  return (
    <Fade
      duration={2000}
      id="About"
      className="res__about text-white w-11/12 mx-auto shadow-2xl"
    >
      <div className="res__about-container">
        <div className="res__about-paragraph text-black">
          ...
          appreciation for music. Whether you're a beginner or looking to refine
          your skills, join us on this incredible journey of self-expression and
          musical mastery. Unleash your potential with us today!
        </div>
