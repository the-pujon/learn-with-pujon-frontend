...
const ManageCategories = () => {
  ...
  useEffect(() => {
    get("categories", "getCategories").then((data) => {
  ...
  const handleSubcategorySubmit = (e) => {
    ...
    post(
      ...
      { SubCategoryName: SubCategoryName, SubCategorySlug: SubCategorySlug },
      "SubcategorySubmit"
    ).then(() => {
      form.reset();
      setRefresh(true);
  ...
  return (
    <div className="wrapper min-h-screen  text-primary backdrop-blur-md">
      <div className="text-4xl font-semibold py-5 sm:pt-[8rem]">
        Manage Categories
      </div>
        ...
        <div className="basis-[35rem]">
          ...
          <div className="pb-10">
            ...
            <form action="" onSubmit={handleCategorySubmit}>
              ...
              <button
                disabled={loading === "CategorySubmit" ? true : false}
                type="submit"
                className="SVButton-2 py-1 px-2 disabled:cursor-not-allowed"
              >
                {loading === "CategorySubmit" ? "Loading" : "Save"}
              </button>
            </form>
          </div>
          ...
          <>
            ...
            <form action="" onSubmit={handleSubcategorySubmit}>
              ...
              <button
                disabled={loading === "SubcategorySubmit" ? true : false}
                type="submit"
                className="SVButton-2 py-1 px-2 disabled:cursor-not-allowed"
              >
                {loading === "SubcategorySubmit" ? "Loading" : "Save"}
              </button>
            </form>
          </>
        </div>
